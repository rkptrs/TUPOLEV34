...
[cl_distribution_ref, cm_distribution_ref, Y_distribution_ref, chord_distribution_ref, CLwing_ref, CDwing_ref] = Q3D_function(x_section_ref, y_section_ref, z_section_ref, c_section_ref, twist_section_ref, [Aur; Alr], [Aut, Alt], 1, 150, CL_design_ref, s.V, s.rho, s.alt, s.Re, s.M);
[W_fuel_ref] = Brequet_function(CLwing_ref, CDwing_ref, s.W_TO_max, 0, 0);
