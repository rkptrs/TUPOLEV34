...
lb = [3,  0.2,  10,  0.5,   0.5,   -5,    -5, Aur_ref' - 0.5*abs(Aur_ref)',Alr_ref' - 0.5*abs(Alr_ref)',Aut_ref' - 0.5*abs(Aut_ref)',Alt_ref' - 0.5*abs(Alt_ref)']';
ub = [20, 20, 30, 45, 45, 5, 5, Aur_ref' + 0.5*abs(Aur_ref)',Alr_ref' + 0.5*abs(Alr_ref)',Aut_ref' + 0.5*abs(Aut_ref)',Alt_ref' + 0.5*abs(Alt_ref)']';
